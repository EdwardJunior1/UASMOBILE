...
import SearchComponent from '../bahan_1/PencarianUser';
import CardUserComponent from '../bahan_1/User';
import VectorIcon from 'react-native-vector-icons/Ionicons'
import Icon from 'react-native-vector-icons/Feather'
import { createUser,editUser, listUser, removeUser } from './UserService';
import PencarianUser from '../bahan_1/PencarianUser';
...
const UserTampilan = () => {
    ...
    <View style={styles.container}>
        <PencarianUser placeholder={'Search User. . .'} sortTitle={'FILTER'} />
        <FlatList
            data={users}
            renderItem={({ item: user }) => <User data={user} handleClicked={handleSelectedUser} handleDeleteUser={handleDeleteUser}/>}
            keyExtractor={({ id }) => id}
        />
